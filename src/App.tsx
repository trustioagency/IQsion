...
function Router() {
  ...
  return (
    <div className="flex h-screen bg-black dark:bg-black light:from-slate-50 light:via-blue-50 light:to-slate-50 text-slate-300 dark:text-slate-300 light:text-slate-700">
      <Sidebar />
      <div className="flex flex-col flex-1 w-full min-w-0 overflow-hidden">
        <Header currentPage="Dashboard" />
        <main className="flex-1 overflow-y-auto bg-black dark:bg-black light:bg-white/60 p-6">
          <Switch>
